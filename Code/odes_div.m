...
dydt(101)=p.ks_cpdr*p.J1/(y(101-100)+p.J1)-p.kd_cpdr*y(101-100)*y(101)/(y(101-100)+p.J2)...
      +p.k2_pos*y(101+200)*p.divkp_free/(p.divkp_free+p.J3)-p.k2_neg*y(101)+p.kcpdr_b_f*y(101+100)-p.kcpdr_f_b*y(101)*y(101+400)...
      +(p.D_cpdr/y(501)^2)*(y(102)-y(101));
for v2a=102:149
  dydt(v2a)=p.ks_cpdr*p.J1/(y(v2a-100)+p.J1)-p.kd_cpdr*y(v2a-100)*y(v2a)/(y(v2a-100)+p.J2)...
      +p.k2_pos*y(v2a+200)*p.divkp_free/(p.divkp_free+p.J3)-p.k2_neg*y(v2a)+p.kcpdr_b_f*y(v2a+100)-p.kcpdr_f_b*y(v2a)*y(v2a+400)...
      +(p.D_cpdr/y(501)^2)*(y(v2a-1)-2*y(v2a)+y(v2a+1));
end
dydt(150)=p.ks_cpdr*p.J1/(y(150-100)+p.J1)-p.kd_cpdr*y(150-100)*y(101)/(y(150-100)+p.J2)...
      +p.k2_pos*y(150+200)*p.divkp_free/(p.divkp_free+p.J3)-p.k2_neg*y(150)+p.kcpdr_b_f*y(150+100)-p.kcpdr_f_b*y(150)*y(150+400)...
      +(p.D_cpdr/y(501)^2)*(y(149)-y(150));  
dydt(151)=p.ks_cpdr*p.J1/(y(151-100)+p.J1)-p.kd_cpdr*y(151-100)*y(101)/(y(151-100)+p.J2)...
      +p.k2_pos*y(151+200)*p.divkp_free/(p.divkp_free+p.J3)-p.k2_neg*y(151)+p.kcpdr_b_f*y(151+100)-p.kcpdr_f_b*y(151)*y(151+400)...
      +(p.D_cpdr/y(501)^2)*(y(152)-y(151)); 
for v2b=152:199
  dydt(v2b)=p.ks_cpdr*p.J1/(y(v2b-100)+p.J1)-p.kd_cpdr*y(v2b-100)*y(v2b)/(y(v2b-100)+p.J2)...
      +p.k2_pos*y(v2b+200)*p.divkp_free/(p.divkp_free+p.J3)-p.k2_neg*y(v2b)+p.kcpdr_b_f*y(v2b+100)-p.kcpdr_f_b*y(v2b)*y(v2b+400)...
      +(p.D_cpdr/y(501)^2)*(y(v2b-1)-2*y(v2b)+y(v2b+1));
end  
dydt(200)=p.ks_cpdr*p.J1/(y(200-100)+p.J1)-p.kd_cpdr*y(200-100)*y(v2b)/(y(200-100)+p.J2)...
      +p.k2_pos*y(200+200)*p.divkp_free/(p.divkp_free+p.J3)-p.k2_neg*y(200)+p.kcpdr_b_f*y(200+100)-p.kcpdr_f_b*y(200)*y(200+400)...
      +(p.D_cpdr/y(501)^2)*(y(199)-y(200));

%%CpdR_b
for v3=201:300
  dydt(v3)=-p.kd_cpdr*y(v3-200)*y(v3)/(y(v3-200)+p.J2)+p.kcpdr_f_b*y(v3+300)*y(v3-100)-p.kcpdr_b_f*y(v3)...
  +p.k2_pos*y(v3+200)*p.divkp_oldpole/(p.divkp_oldpole+p.J4)-p.k2_neg*y(v3)...
