...
dydt(150)=p.ks_cpdr*p.cckap/(p.cckap+p.J1)-p.kd_cpdr*y(150-100)*y(101)/(y(150-100)+p.J2)...
      +p.k2_pos*y(150+200)-p.k2_neg*p.cckap*y(150)/(p.cckap+p.J3)+p.kcpdr_b_f*y(150+100)-p.kcpdr_f_b*y(150)...
      +(p.D_cpdr/y(501)^2)*(y(149)-y(150));  
dydt(151)=p.ks_cpdr*p.cckap/(p.cckap+p.J1)-p.kd_cpdr*y(151-100)*y(101)/(y(151-100)+p.J2)...
      +p.k2_pos*y(151+200)-p.k2_neg*p.cckap*y(151)/(p.cckap+p.J3)+p.kcpdr_b_f*y(151+100)-p.kcpdr_f_b*y(151)...
...
dydt(350)=p.k2_neg*p.cckap*y(101)/(p.cckap+p.J3)-p.k2_pos*y(301)+p.kcpdrp_b_f*y(401)-p.kcpdrp_f_b*y(301)...
+p.D_cpdrp*(y(349)-y(350))/(y(501)^2);
dydt(351)=p.k2_neg*p.cckap*y(101)/(p.cckap+p.J3)-p.k2_pos*y(301)+p.kcpdrp_b_f*y(401)-p.kcpdrp_f_b*y(301)...
