...
dydt(200)=p.ks_cpdr-p.kd_cpdr*y(200-100)*y(v2)/(y(200-100)+p.J2)...
      ...
      +p.kcpdr_b_f*y(200+100)-p.kcpdr_f_b*y(200)*y(200+400)...
      +(p.D_cpdr/y(601)^2)*(y(199)-y(200));
%%CpdR_b
for v3=201:300
  dydt(v3)=-p.kd_cpdr*y(v3-200)*y(v3)/(y(v3-200)+p.J2)...
      +p.kcpdr_f_b*y(v3+300)*y(v3-100)-p.kcpdr_b_f*y(v3)...
